...
AGENDA = [
    ...
    {
        "id": "5", "title": "FP 68261303 — Multi Company Setup (DTP1092 / College Staff)",
        "pill": "info", "owner": "Simon",
        "desc": "Simon updated Conor O'Brien (Access Group) with the team's post-design proposal on 23 June; the email was sitting in Kevin's Needs tray awaiting review.",
        ...
        "current": "Command Centre marks the related tasks (t021 Multi Company Setup, t005 REF2029 pay admin codes, t020 COREPORTAL_ADMIN) as <b>done</b>, with real dated progress through early July: Tony Boydell sent Acceptance Criteria for Company&nbsp;10/Company&nbsp;90 user scenarios (3&nbsp;Jul), Crispin Muncaster gave a Company&nbsp;90 testing update (7&nbsp;Jul). Kevin's own July leave handover (prepared ~9&nbsp;July) adds: bucket posts in, dummy data build unblocked, cost £4,500 agreed, integration call scheduled 10&nbsp;July with Stephen and Guy Williams, funding closing end of July, go-live October. Work Inbox (28&nbsp;Jul, after Kevin's return) shows the project still active but slipping: Crispin extended the \"College Staff into PXD\" team meeting to <b>early September</b>, and Guy Williams forwarded integrations-testing detail the same day. Nothing confirms whether the 10&nbsp;July call itself happened, or whether the Connor/Access Group meeting on self-service field visibility was ever arranged.",
        "say": "Company 90 — Command Centre shows real testing progress through early July and the team meeting's now pushed to early September. Did the 10 July call with Stephen and Guy happen, and did the Connor meeting on self-service field visibility ever get arranged?",
    },
    {
...
GLANCE_TABLE = """<table>
          ...
          <tbody>
            ...
            <tr><td class="idcell">5</td><td>Company 90 / DTP1092</td><td>Simon</td><td><span class="pill pill-info">Update</span></td></tr>
