...
SK_ITEMS = [
    ...
    {"id": "2", "title": "Support James &mdash; applicant data import report", "pill": "info", "owner": "Kevin",
     "note": "Dig into Lee/Grace's old emails for background; meeting with James set 20&nbsp;Aug, outcome not confirmed. Distinct from the separate Cority Applicant Data Import thread."},
