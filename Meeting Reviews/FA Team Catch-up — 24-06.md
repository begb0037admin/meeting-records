...
### 9. Flex points — 5 days to expiry (29 June)
**Ask:** Any word on the Holiday Records Reports quote from Mike West / Ann-Marie Topliss (case 69001638)? What is the remaining balance once committed spend is confirmed?

**Background:** Kevin holds 2,935 flex points with Access Group, expiring on 29 June 2026. Flex points are a pre-purchased block of consultancy time from Access Group (PeopleXD’s supplier) used for system changes, reports, and configuration work. Once expired, unused points are lost. Simon and Marie agreed a plan would be ready when Marie returned from leave; the plan is being built around a small number of committed items.

One item is already committed: Chemistry bulk deletion (£525), approved by Marie and in flight (see item 7 above). The main remaining use being progressed is Holiday Records Reports — a set of three reports scoped by Athena Artuso covering holiday records duty requirements. Kevin reviewed the spec on 11 June and confirmed it aligns with requirements. A quote was requested from Mike West (Access Group) and Ann-Marie Topliss on 15 June. Ann-Marie confirmed on 20 June that the case (#69001638) has been formally transitioned to the Optimisation Services team and is progressing to quote stage. Marie Cooksey’s sign-off on the flex points spend was sought on 17 June.

No quote has been received as of 23 June. With 5 days until expiry, if the quote does not arrive today or tomorrow there will not be enough time to review, approve, and commit the remaining balance. If the quote is not imminent, Kevin may need to identify an alternative use for the remaining points or accept that a portion will lapse. Access Group point of contact is Mike West / Ann-Marie Topliss.
...
- Chase Mike West / Ann-Marie Topliss on flex points quote if not in inbox

---

*Prepared: 23 June 2026 | Sources: Granola (FA Catch-up 18/06, HR Systems Roadmap 19/06), Command Centre tasks.json, Work Inbox briefing.json (refreshed 17:31 Tue 23 Jun)*